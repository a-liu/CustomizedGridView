...
public class TableViewConstants {
    /**
     * 单元格中预设空白长度
     */
    ...
    public static final int CELL_MARGIN_TOP = -1;
    public static final int CELL_MARGIN_LEFT = 0;
    public static final int CELL_MARGIN_RIGHT = 0;
    public static final int CELL_MARGIN_BOTTOM = -1;
    ...
    public static final int CELL_PADDING_LEFT = 0;
    public static final int CELL_PADDING_RIGHT = 0;
