...
public class GridViewBeanComparator implements Comparator {
    /**
     * 排序方式
     */
    ...
    public GridViewBeanComparator(boolean convertIntegerFlag,int position, ORDER_TYPE orderType) {
        super();
    ...
    private Object getCellValue(GridViewRowBean bean, int position)
    {
        Object result = null;
    ...
    public int compare(Object o1, Object o2) {
        ...
        {
            try {
                Object obj1=getCellValue((GridViewRowBean) o1, mPosition);
                Object obj2=getCellValue((GridViewRowBean) o2, mPosition);
